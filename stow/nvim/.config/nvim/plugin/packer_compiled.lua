...
_G.packer_plugins = {
  ...
  ["nvim-colorizer.lua"] = {
    commands = { "Colorizer" },
    config = { "\27LJ\2\nô\1\0\0\4\0\6\0\t6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\4\0005\3\3\0=\3\5\2B\0\2\1K\0\1\0\25user_default_options\1\0\0\1\0\a\tmode\15foreground\vcss_fn\2\bcss\1\rRRGGBBAA\1\nnames\1\vRRGGBB\2\bRGB\2\nsetup\14colorizer\frequire\0" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
  ...
  ["nvim-dap"] = {
    after = { "nvim-dap-ui", "nvim-dap-go", "nvim-dap-virtual-text" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-visual-multi', 'gitsigns.nvim', 'Comment.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
