...
_G.packer_plugins = {
  ...
  ["nvim-autopairs"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/brian/.local/share/nvim/site/pack/packer/opt/nvim-autopairs",
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-sandwich', 'vim-sneak', 'vim-visual-multi', 'nvim-autopairs', 'gitsigns.nvim', 'Comment.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
